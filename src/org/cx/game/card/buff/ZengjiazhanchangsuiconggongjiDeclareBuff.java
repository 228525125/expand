...
public class ZengjiazhanchangsuiconggongjiDeclareBuff extends Buff {

	public final static Integer ZengjiazhanchangsuiconggongjiBuff_ID = 10300008;
	
	private Integer atkUpValue = 0;
	
	public ZengjiazhanchangsuiconggongjiDeclareBuff(Integer atkUpValue, Integer bout, LifeCard life) {
